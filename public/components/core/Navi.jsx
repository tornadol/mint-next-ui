...
const popularProducts = [
  { img: '../../assets/imagery/coins/coin-01.png', title: 'Landmarks of Singapore Medallion', code: 'L233', price: 'S$ 120' },
  { img: '../../assets/imagery/coins/coin-03.png', title: 'Canada Winning Goal 1oz Silver Proof', code: 'L221', price: 'S$ 128' },
  { img: '../../assets/imagery/coins/coin-08.png', title: 'Chinese Zodiac Rabbit 1/4 oz Gold Proof', code: 'L288', price: 'S$ 640' },
  { img: '../../assets/imagery/coins/coin-11.png', title: 'Merlion 55th Anniversary Silver Medallion', code: 'L299', price: 'S$ 208' },
  { img: '../../assets/imagery/coins/coin-07.png', title: 'Peranakan Heritage 1oz Silver Proof', code: 'L266', price: 'S$ 168' },
  { img: '../../assets/imagery/coins/coin-12.png', title: 'Orchid Series — Vanda Miss Joaquim', code: 'L301', price: 'S$ 88' },
  { img: '../../assets/imagery/coins/coin-13.png', title: 'MRT 40th Anniversary Coloured Medallion', code: 'L310', price: 'S$ 108' },
  { img: '../../assets/imagery/coins/coin-05.png', title: 'National Day 2023 Silver Proof Medallion', code: 'S217', price: 'S$ 65' },
];

export function Navi({ items = ['Shop', 'About Us', 'Latest', 'Contact Us'], active = 'Shop', logoSrc = LOGO, sticky = true, style }) {
  ...
  return (
    <>
      ...
      <header style={{
        ...
        <div style={{ height: '100%', maxWidth: 1280, margin: '0 auto', display: 'flex', alignItems: 'center', padding: '0 24px', boxSizing: 'border-box' }}>
          <a href="index.html" aria-label="Home" style={{display:'inline-flex',alignItems:'center',flexShrink:0}}><img src={logoSrc} alt="The Singapore Mint" style={{ height: 32, width: 'auto', flexShrink: 0 }} /></a>

          <nav className="sm-navi-links">
            {/* Shop with dropdown */}
          ...
          <div className="sm-navi-right">
                ...
                {userMenuOpen && (
                  <div style={{position:'absolute',top:'100%',right:0,paddingTop:10,minWidth:220,zIndex:160}}>
                    <div style={{background:'#fff',borderRadius:6,boxShadow:'0 12px 32px rgba(0,0,0,.16),0 0 0 1px rgba(0,0,0,.06)',padding:6}}>
                      ...
                      <a href="account.html" style={{display:'flex',alignItems:'center',gap:10,padding:'9px 12px',borderRadius:4,color:'var(--ink-1000)',fontFamily:'var(--font-label)',fontWeight:600,fontSize:13,textDecoration:'none'}} onMouseEnter={e=>e.currentTarget.style.background='var(--ink-25)'} onMouseLeave={e=>e.currentTarget.style.background='transparent'}>
                        <Icon name="Info" size={16}/> Info
                      </a>
                      <a href="order-history.html" style={{display:'flex',alignItems:'center',gap:10,padding:'9px 12px',borderRadius:4,color:'var(--ink-1000)',fontFamily:'var(--font-label)',fontWeight:600,fontSize:13,textDecoration:'none'}} onMouseEnter={e=>e.currentTarget.style.background='var(--ink-25)'} onMouseLeave={e=>e.currentTarget.style.background='transparent'}>
                        <Icon name="Receipt" size={16}/> Order History
                      </a>
            ...
            <div ref={wishRef} style={{position:'relative',display:'inline-flex'}}
            ...
            <div ref={compareRef} style={{position:'relative',display:'inline-flex'}}
      ...
      <div className={`sm-drawer${drawerOpen ? ' open' : ''}`}>
        ...
        <div className="sm-drawer-panel">
          ...
          <nav className="sm-drawer-nav">
            {['Shop', ...items.filter(i => i !== 'Shop')].map(i => (
              <a key={i} href={i === 'Shop' ? 'product-list.html' : '#'} onClick={() => setDrawerOpen(false)}
                style={{ fontWeight: i === active ? 800 : 700, color: i === active ? 'var(--brand-red-800)' : 'var(--ink-1000)' }}>
                {i}
              </a>
            ))}
          </nav>
          <div className="sm-drawer-footer">
            ...
            <a href="#" style={{ display: 'flex', alignItems: 'center', gap: 10, color: 'var(--ink-1000)', fontFamily: 'var(--font-label)', fontWeight: 700, fontSize: 15, textDecoration: 'none' }}>
